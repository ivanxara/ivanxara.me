...
export function ExperienceSection({
  ...
  return (
    ...
    >
      ...
      >
        <p className="max-w-4xl text-[clamp(1.8rem,4.5vw,4rem)] font-black leading-[1] tracking-[-0.06em] text-ink">
      ...
      <div className="mt-14 border-t border-line sm:mt-16">
        {MY_EXPERIENCE.map((item, index) => (
          ...
          >
            <div>
              <h3 className="text-[clamp(1.8rem,3vw,2.8rem)] font-black leading-[0.95] tracking-[-0.06em] text-ink">
                {item.organization}
              </h3>
              <p className="mt-2 text-sm font-semibold lowercase tracking-[-0.02em] text-muted">
                {item.role}
              </p>
            </div>

            <div className="lg:pt-1">
              <span className="text-[13px] font-semibold lowercase tracking-[-0.01em] text-accent">
                {item.period}
              </span>
              <p className="mt-3 max-w-lg text-sm leading-[1.7] lowercase tracking-[-0.01em] text-muted sm:text-[15px]">
                {item.description}
              </p>
            </div>
          </motion.div>
